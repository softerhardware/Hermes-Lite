...
localparam data_size = 1; 			// Last RAM address ***** NOTE: vary RAM size if more/less data to be sent ******
...
REG_address[0] <= 5'd0;  REG_data[0] <= 16'h1000;				
REG_address[1] <= 5'd0;  REG_data[1] <= 16'h1000;	
