...
module  clkmux_sdk_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clkmux_sdk_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clkmux_sdk_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    inclk2x,
...
`endif
    ...
    clkmux_sdk_altclkctrl_0_sub  clkmux_sdk_altclkctrl_0_sub_component (
                .clkselect (clkselect),
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
